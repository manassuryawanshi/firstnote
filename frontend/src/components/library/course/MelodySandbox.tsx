  ...
  return (
    <div className="w-full rounded-3xl border border-black/10 dark:border-white/10 bg-gradient-to-b from-blue-900/20 to-purple-900/20 p-8 flex flex-col items-center">
      ...
      <button
         ...
         disabled={!isLoaded}
         className={`flex items-center gap-2 px-8 py-4 rounded-full font-bold transition-all mb-12 ${isPlayingBacking ? 'bg-blue-500 text-zinc-900 dark:text-white shadow-[0_0_20px_rgba(244,63,94,0.4)]' : 'bg-white text-black hover:scale-105'}`}
      >
